...
┌─────────────────────────────────────────┐
│                                         │
│         ◉ (orange) SMPL skeleton        │
│         ● (green) Target keypoints      │
│         █ (robot) MuJoCo render         │
│                                         │
│              ◉                          │
│              │                          │
...
│                                    │ ● L_Hip      │
│    ●══●          ●══●              │ ● L_Knee     │
│   shoulders    elbows              │ ● L_Ankle    │
│                                    │ ● R_Hip      │
│      ●══════════●                  │ ● R_Knee     │
│     pelvis correspondence          │ ● R_Ankle    │
│                                    │ ● L_Shoulder │
│    ●══●        ●══●                │ ● L_Elbow    │
│    hips        knees               │ ● L_Wrist    │
│                                    │ ● R_Shoulder │
│    ●══●        ●══●                │ ● R_Elbow    │
│   ankles      wrists               │ ● R_Wrist    │
│                                    │              │
└────────────────────────────────────┴──────────────┘
```
...
│                                                     │
│         ●←●←●←●←●←●←●←●                            │
│         (fading trail showing motion history)       │
│                                                     │
└─────────────────────────────────────────────────────┘
```
